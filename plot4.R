...
# Create a PNG file for plot4: multiplot
png(filename = paste0(projectWD, "plot4.png"), width=480, height=480, units='px')

par(mfrow = c(2, 2), mar = c(4, 4, 2, 1), oma = c(0, 0, 2, 0))
with(dataSubset, 
     {
       plot(Global_active_power ~ Time, type = "l", ylab = "Global Active Power", xlab = "")
